<x-admin-layout>
    <div class="flex  justify-end px-4">
        <x-filament::button class="" href="{{ route('conditions') }}" tag="a" icon="heroicon-m-arrow-left"
            color="gray">
        ...
        <div class="grid grid-cols-12 gap-x-8">
            ...
            <div class="col-span-6  grid grid-cols-12">
                <div class="col-span-12">
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            @foreach ($record->treatments as $treatment)
                                                <tr>
                                                    ...
                                                    <td
                                                        class="relative whitespace-nowrap py-4  text-right text-sm font-medium sm:pr-0 flex items-center justify-end">
                                                        <div class="mr-3">
                    ...
                    <div class="px-4 sm:px-6 lg:px-8 bg-white py-6 rounded-lg mt-8">
                        <div class="sm:flex sm:items-center ">
                            <div class="sm:flex-auto">
                                <h1 class="text-base font-semibold leading-6 text-gray-900">Symptoms</h1>

                            </div>
                            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                                {{-- <button type="button" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add user</button> --}}
                                {{ $this->createSymptomAction }}
                            </div>
                        </div>
                        <div class=" flow-root">
                            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                    <table class="min-w-full divide-y divide-gray-300">
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            @foreach ($record->symptoms as  $key => $symptom)
                                                <tr>
                                                    <td
                                                        class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                                                        {{ $symptom->name }}</td>
                                                    ...
                                                    <td
                                                        class="relative whitespace-nowrap py-4  text-right text-sm font-medium sm:pr-0 flex items-center justify-end">
                                                        <div class="mr-3">
                                                            {{ ($this->viewSymptomAction)(['record' => $symptom->id]) }}

                                                        </div>
                                                        <div class="mr-3">
                                                            {{ ($this->editSymptomAction)(['record' => $symptom->id]) }}

                                                        </div>
                                                        <div class="">
                                                            {{ ($this->deleteSymptomAction)(['record' => $symptom->id]) }}
