    ...
    <div class="hidden lg:ml-4 lg:block">
        <div class="flex flex-col items-center justify-center">
            ...
            <div x-data="{ dropdownOpen: false }" class="relative">
                <div>
                    <button @click="dropdownOpen = !dropdownOpen" type="button" class="relative flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-kaitoke-green-600 " id="user-menu-button" aria-expanded="false" aria-haspopup="true">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button type="button" class="relative inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-kaitoke-green-600  " aria-controls="mobile-menu" aria-expanded="false">
