        ...
        <aside class="w-1/4 bg-white max-h-screen p-4 shadow-lg rounded-lg space-y-6">
            ...
            <nav class="space-y-2">
                <a href="#" class="block p-3 bg-blue-50 rounded-lg hover:bg-blue-100">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block mr-2" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path
                            d="M18 9a9 9 0 11-9-9 9 9 0 019 9zM6.707 10.707a1 1 0 01-1.414-1.414L8.586 6H3a1 1 0 010-2h7a1 1 0 011 1v7a1 1 0 11-2 0V8.414l-2.293 2.293z" />
                    </svg>
                    Watch Videos
                </a>
                <a href="#" class="block p-3 rounded-lg hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block mr-2" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path
                            d="M5 3a1 1 0 00-1 1v10a1 1 0 001 1h3v1h4v-1h3a1 1 0 001-1V4a1 1 0 00-1-1H5zm1 2h8v8H6V5z" />
                    </svg>
                    Marketplace
                </a>
